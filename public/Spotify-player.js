...
!(function e(t, r, n) {
...
})(
	{
		1: [
			...
			{ './logger': 6, './promise_resolver': 8, './user_agent': 9, tslib: 12 }
		],
		2: [
			function (e, t, r) {
				'use strict';
				Object.defineProperty(r, '__esModule', { value: !0 }), (r.LoggingError = void 0);
				var n = e('tslib'),
					o = (function (e) {
						function t(t, r, n) {
		...
		5: [
			function (e, t, r) {
				...
				Object.defineProperty(r, '__esModule', { value: !0 }),
					(r.LogValues = void 0),
					(r.LogValues = { UNKNOWN: 'unknown', EMPTY: '', ZERO: 0, EMPTY_VERSION: '0.0.0' });
			},
			{}
		],
		6: [
			...
			{ './enums/errors': 4, './enums/log_values': 5, './logger': 7, tslib: 12 }
		],
		7: [
			function (e, t, r) {
				'use strict';
				Object.defineProperty(r, '__esModule', { value: !0 }), (r.MelodyLogger = void 0);
				var n = e('tslib'),
					o = e('./enums/errors'),
					...
					u = (function () {
						function e(e) {
							(this._transport = e.transport),
								(this._endpoint = e.endpoint || '@webgate/melody'),
								(this._identData = Promise.all([e.sdkId, e.platform, e.clientVersion]).then(function (
									e
								) {
									var t = e[0],
										r = e[1],
							...
							(e.prototype.sendLog = function (e, t, r) {
								...
								return this._identData
									.then(function (r) {
										...
										return (
											i && (o = a.urlWithQueryParam(o, 'access_token', i)),
		...
		10: [
			function (e, t, r) {
				'use strict';
				Object.defineProperty(r, '__esModule', { value: !0 }), (r.interpolateUA = void 0);
				var n = e('./parse_ua');
		...
		11: [
			function (e, t, r) {
				'use strict';
				Object.defineProperty(r, '__esModule', { value: !0 }), (r.parseUA = void 0);
				var n = /(edge)[\s\/:]([\w\d\.]+)/,
					o = new RegExp(
				...
				r.parseUA = function (e, t) {
					...
					var E = u.match(n),
						...
						p = E || f;
					'trident' === p[1] ? ((p[1] = 'ie'), p[4] && (p[2] = p[4])) : 'crios' === p[1] && (p[1] = 'chrome'),
						'win' ===
							(c = u.match(/ip(?:ad|od|hone)/)
								? 'ios'
								: null !==
										(r = (u.match(/(?:webos|android)/) ||
...
***************************************************************************** */
						...
						!(function (r) {
							...
							(R = function (e) {
								...
								e('__asyncValues', h),
								e('__makeTemplateObject', T),
								e('__importStar', R),
								e('__importDefault', m),
								e('__classPrivateFieldGet', A),
		...
		17: [
			function (e, t, r) {
				'use strict';
				Object.defineProperty(r, '__esModule', { value: !0 }), (r.PlayerError = void 0);
				var n = e('tslib'),
					o = (function (e) {
						function t(t, r) {
		...
		18: [
			function (e, t, r) {
				...
				function i() {
					...
					if (((window.Spotify = { Player: s.setupPlayerEnv(window) }), window.onSpotifyWebPlaybackSDKReady))
			...
			{ '../enums/errors': 13, '../error/player_error': 17, './player_api': 19 }
		],
		19: [
			function (e, t, r) {
				'use strict';
				Object.defineProperty(r, '__esModule', { value: !0 }), (r.setupPlayerEnv = void 0);
				var n = e('tslib'),
					o = e('@js-sdk/common'),
					s = e('../enums/messages'),
					i = e('../enums/events'),
					...
					return (function () {
						function t(t) {
							...
							(this._options = {
								name:
									t.name ||
									(null === (o = null == e ? void 0 : e.location) || void 0 === o
										? void 0
										: o.hostname) ||
									'',
								...
								(this._eventListeners =
									(((r = {})[a.HumanizedEvents.ACCOUNT_ERROR] = []),
									(r[a.HumanizedEvents.AUTH_ERROR] = []),
									(r[a.HumanizedEvents.AUTOPLAY_FAILED] = []),
								...
								(this._messageHandlers =
									(((n = {})[s.Messages.GET_TOKEN] = this._onGetToken.bind(this)),
									(n[s.Messages.EVENT] = this._onEvent.bind(this)),
									(n[s.Messages.CONNECTED] = this._onConnected.bind(this)),
									(n[s.Messages.CURRENT_STATE] = this._onCurrentState.bind(this)),
									(n[s.Messages.VOLUME] = this._onVolume.bind(this)),
									n)),
								(this.isLoaded = E.promise.then(function () {
						...
						return (
							...
							(t.prototype._onGetToken = function (e, t) {
								...
								if ('function' == typeof n)
									...
									if (!this._getListeners(a.HumanizedEvents.PLAYER_INIT_ERROR).length)
									...
									this._onEvent({
										...
										eventData: { message: u.Errors.INVALID_OAUTH }
									});
								}
							}),
							...
							(t.prototype.connect = function () {
								...
								return this.isLoaded.then(function () {
									var t,
										r = e._sendMessage(l.messages.connect());
									return (
										(e._connectionRequests[r] = o.createPromiseResolver()),
										null === (t = e._connectionRequests[r]) || void 0 === t ? void 0 : t.promise
									);
								});
							}),
							...
							(t.prototype.getCurrentState = function () {
								...
								return this.isLoaded.then(function () {
									var t,
										r = e._sendMessage(l.messages.getCurrentState());
									return (
										(e._getCurrentStateRequests[r] = o.createPromiseResolver()),
							...
							(t.prototype.getVolume = function () {
								...
								return this.isLoaded.then(function () {
									var t,
										r = e._sendMessage(l.messages.getVolume());
									return (
										(e._getVolumeRequests[r] = o.createPromiseResolver()),
										null === (t = e._getVolumeRequests[r]) || void 0 === t ? void 0 : t.promise
									);
								});
							}),
		...
		20: [
			function (e, t, r) {
				'use strict';
				Object.defineProperty(r, '__esModule', { value: !0 }), (r.MessageDispatcher = void 0);
		...
		21: [
			function (e, t, r) {
				'use strict';
				Object.defineProperty(r, '__esModule', { value: !0 }), (r.messages = void 0);
				var n = e('../enums/messages'),
					o = (function () {
						function e() {}
						return (
							...
							(e.prototype._createEventMessage = function (e, t) {
								return this._createMessage(n.Messages.EVENT, { name: e, eventData: t });
							}),
							...
							(e.prototype.accountError = function (e) {
								return this._createEventMessage(n.Messages.ACCOUNT_ERROR, { message: e });
							}),
							...
							(e.prototype.connected = function (e, t) {
								return this._createMessage(n.Messages.CONNECTED, { connected: e, ref: t });
							}),
							...
							(e.prototype.token = function (e, t) {
								return this._createMessage(n.Messages.TOKEN, { token: e, ref: t });
							}),
							...
							(e.prototype.currentState = function (e, t) {
								return this._createMessage(n.Messages.CURRENT_STATE, { state: e, ref: t });
							}),
							...
							(e.prototype.volume = function (e, t) {
								return this._createMessage(n.Messages.VOLUME, { volume: e, ref: t });
							}),
